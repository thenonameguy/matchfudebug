...
# translation
SOURCES = matcherofflinedebug.py ui_matcherofflinedebug.py __init__.py matcherofflinedebugdialog.py
#TRANSLATIONS = i18n/matcherofflinedebug_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = matcherofflinedebug

PY_FILES = matcherofflinedebug.py matcherofflinedebugdialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_matcherofflinedebug.py
